...
export default function Login() {
  ...
  return (
    <>
      ...
      <div className="bg-surface text-on-surface font-body-md overflow-x-hidden selection:bg-secondary-fixed min-h-screen flex flex-col md:flex-row">
        ...
        <section className="flex-1 flex flex-col bg-surface-container-lowest md:rounded-l-[40px] shadow-2xl z-30 overflow-y-auto custom-scrollbar">
          ...
          <div className="max-w-md w-full mx-auto flex-1 flex flex-col justify-center px-gutter py-12">
            ...
            <div className="flex border-b border-outline-variant mb-8">
              ...
              <button className="flex-1 py-4 text-center font-label-md text-label-md text-on-surface-variant hover:text-on-surface transition-all">
                Register
              </button>
            </div>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div>
                <label className="block font-label-md text-label-md text-on-surface-variant mb-2 ml-1" htmlFor="email">Email Address</label>
                <input 
              ...
              <div>
                <div className="flex justify-between mb-2">
                  <label className="block font-label-md text-label-md text-on-surface-variant ml-1" htmlFor="password">Password</label>
              ...
              <button 
                className={`w-full h-14 bg-secondary text-white rounded-xl font-label-md text-label-md saffron-glow hover:bg-secondary/90 active:scale-[0.98] transition-all flex items-center justify-center gap-2 group ${isLoading ? 'opacity-80 pointer-events-none' : ''}`} 
                type="submit"
                disabled={isLoading}
              >
                {isLoading ? (
